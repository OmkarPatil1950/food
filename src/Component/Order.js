  ...
  return (
    ...
    >
      {data.length > 0 && data[0].orderItems.length > 0 ? (
        ...
        <button
          class="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 ml-3 border border-blue-500 hover:border-transparent rounded"
          onClick={handleOrder}
        >
